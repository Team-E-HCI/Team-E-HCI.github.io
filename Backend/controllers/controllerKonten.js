...
const tampilkanKategoriError = asyncHandler(async (req, res) => {
  try {
    const konten = await Konten.find({
      kategori: "Error",
    })
...
const tampilkanKategoriAI = asyncHandler(async (req, res) => {
  try {
    const konten = await Konten.find({
...
const tampilkanKategoriML = asyncHandler(async (req, res) => {
  try {
    const konten = await Konten.find({
