        ...
        <div className="row">
          <div className="col-sm-7 full-ask">
            <div className="wrap">
              ...
              <label className="form-ask" for="username">Judul</label>
              <br/>
              <FormControl className="ipt-ask" aria-label="Small" aria-describedby="inputGroup-sizing-sm" />
              <br/>
              <label className="form-ask" for="konten">Konten</label>
              <br/>
              <FormControl as="textarea" className="ipt-ask-cntn" aria-label="With textarea" />
              <br/>
