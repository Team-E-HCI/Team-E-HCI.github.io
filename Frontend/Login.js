  ...
  <body className="body">
      <nav className="navbar fixed-top" id="all">
        <NavItem className="nav" id="left">
          <a className="nav-link up" href="/"><img className="face" width="50%" src={logo}/></a>
        </NavItem>
        <NavItem className="nav justify-content-end" id="right">
            <NavLink className="nav-link ataslog" href='/Masuk'>Masuk</NavLink>
            <NavLink className="nav-link ataslog" href='/Daftar'>Daftar</NavLink>
            <NavLink className="nav-link ataslog" href='/Tentang'>Tentang</NavLink>
            <NavLink className="nav-link ataslog" href='/Kontak'>Kontak Kami</NavLink>
        </NavItem>
      </nav>
        ...
        <div className="row">
          <div className="col-sm-12 full">
            <div className="wrap">
              ...
              <label className="form" for="username">Email/Username</label>
              <br/>
